...
namespace ConsoleApplication1
{
    class Program
    {
        ...
        static void MostrarMenu(int conteo, int MaxP)
        {
            ...
            Console.Write("-----------------------------------------------------");
            Console.WriteLine();
            Console.Write("Ingrese la opción que quiere");
        }
        ...
        static void NuevoPersonaje(ref int conteo, int MaxP, ref string[,] personajes)
        {
            if (conteo == MaxP)
            {
                Console.WriteLine("La lista de personajes se lleno");
                Console.ReadLine();
                return;
            }
        ...
        static void ConsultarPersonaje(ref int conteo, ref string[,] personajes)
        {
            ...
            {
                Console.WriteLine("Seleccione el personaje por su número:");
                for (int i = 0; i < conteo; i++)
                {
                    Console.WriteLine((i + 1) + personajes[i, 0]);
                }

                Console.Write("Ingrese el número del personaje que quiere consultar: ");
        ...
        static void ModificarPersonaje(ref int conteo, int MaxP, ref string[,] personajes)
        {
            ...
            for (int i = 0; i < conteo; i++)
            {
                if (personajes[i, 0] == nombre)
                {
                    ...
                    Console.WriteLine("lvl fuerza: " + personajes[i, 2]);
                    Console.WriteLine("lvl defensa: " + personajes[i, 3]);
                    ...
                    Console.WriteLine("¡Personaje modeado con éxito!");
                    encontrado = true;
                    break;
                }
            }
            ...
            if (!encontrado)
            {
                Console.WriteLine("No se encontró el pj.");
            }
        ...
        {
            Console.Write("Ingrese el nombre del personaje que desea eliminar ");
            string nombre = Console.ReadLine();
        ...
        static void MostrarTodosPersonajes(ref int conteo, ref string[,] personajes)
        {
            if (conteo == 0)
            {
                Console.WriteLine("No hay registrados.");
            }
            else
            {
